...
public class UseDemo {
	...
	public static void main(String[] args) throws IOException {
		...
		Document doc = Jsoup.connect("http://www.scau.edu.cn/xw/201508/t20150807_133057.htm").get();
		...
		//System.out.println(TextExtract.parse(text));
	}
